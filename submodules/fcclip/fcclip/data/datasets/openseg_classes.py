...
def get_coco_categories_with_prompt_eng():
    ...
    coco_id_names = open(os.path.join(os.path.dirname(__file__), './coco_panoptic_with_prompt_eng.txt')).read().splitlines()
    coco_idx = 0
...
def get_coco_stuff_categories_with_prompt_eng():
    ...
    coco_id_names = open(os.path.join(os.path.dirname(__file__), './coco_stuff_with_prompt_eng.txt')).read().splitlines()
    coco_idx = 0
    for line in coco_id_names:
        idx, name = line.split(':')
        idx = int(idx)
...
def get_ade20k_categories_with_prompt_eng():
    ...
    ade20k_id_names = open(os.path.join(os.path.dirname(__file__), './ade20k_150_with_prompt_eng.txt')).read().splitlines()
    ade_idx = 0
...
def get_cityscapes_categories_with_prompt_eng():
    ...
    cityscapes_id_names = open(os.path.join(os.path.dirname(__file__), './cityscapes_with_prompt_eng.txt')).read().splitlines()
    cityscapes_idx = 0
...
def get_ade20k_847_categories_with_prompt_eng():
    ...
    ade20k_847_id_names = open(os.path.join(os.path.dirname(__file__), './ade20k_847_with_prompt_eng.txt')).read().splitlines()
    ade_idx = 0
...
def get_pascal_21_categories_with_prompt_eng():
    ...
    pascal_21_id_names = open(os.path.join(os.path.dirname(__file__), './pascal_voc_21_with_prompt_eng.txt')).read().splitlines()
    pas_idx = 0
...
def get_pascal_ctx_459_categories_with_prompt_eng():
    ...
    pascal_ctx_459_id_names = open(os.path.join(os.path.dirname(__file__), './pascal_ctx_459_with_prompt_eng.txt')).read().splitlines()
    pas_idx = 0
...
def get_pascal_ctx_59_categories_with_prompt_eng():
    ...
    pascal_ctx_59_id_names = open(os.path.join(os.path.dirname(__file__), './pascal_ctx_59_with_prompt_eng.txt')).read().splitlines()
    pas_idx = 0
...
def get_mapillary_vistas_categories_with_prompt_eng():
    ...
    mapillary_vistas_id_names = open(os.path.join(os.path.dirname(__file__), './mapillary_vistas_with_prompt_eng.txt')).read().splitlines()
    mapillary_idx = 0
